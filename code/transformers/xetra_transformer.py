...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_dail_traded_vol: column name for daily traded volume in target
...
class XetraETL():
    """
    Extracts, transforms and loads the data from the source to the target
    """
    ...
    def transform_report1(self, data_frame: pd.DataFrame):
        """
        Applies the necessary transformation to create a report
        ...
        if data_frame.empty:
            ...
            return data_frame
        self._logger.info(
            'Applying transformations to Xetra source data for report started...')
    ...
    def etl_report1(self):
        """
        Extract, transform and load to create a report
        """
        # Extract
