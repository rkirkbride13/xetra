...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_read_csv_to_df_ok(self):
        """
        Tests the read_csv_to_df_method for reading a csv file from the mocked s3 bucket
        """
        # Expected results
        key_exp = 'test1.csv'
        col1_exp = 'col1'
    ...
    def test_write_df_to_s3_parquet(self):
        """
        Tests the write_df_to_s3 method if writing parquet is successful
        """
        # Expected results
        return_exp = True
        df_exp = pd.DataFrame([['A', 'B'], ['C', 'D']],
    ...
    def test_write_df_to_s3_wrong_format(self):
        """
        Tests the write_df_to_s3 method when unsupported format given
        """
        # Expected results
        df_exp = pd.DataFrame([['A', 'B'], ['C', 'D']],
                              columns=['col1', 'col2'])
        ...
        log_exp = f'The file format {format_exp} is not supported for writing to S3'
